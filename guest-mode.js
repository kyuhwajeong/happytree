...
<text x="230" y="98" text-anchor="middle" font-size="8.5" fill="#6b7280">날짜 탭 → 해당일 상세 내용으로 즉시 전환</text>
        ...
        {
          text: '≡ <b>화면 구성 편집</b> 버튼입니다.\n\n누르면 편집모드로 바뀌면서 각 위젯에 손잡이(⠿)가 나타나요. 손잡이를 누른 채 끌면 원하는 자리로 바로 옮길 수 있고, 옆에 다른 위젯이 있으면 자동으로 자리를 나눠 나란히 배치됩니다.\n\n숨긴 위젯은 편집모드 상단 바에서 다시 켤 수 있고, "기본 배치로" 버튼으로 언제든 초기 상태로 되돌릴 수 있어요. 설정은 이 기기에만 저장됩니다.',
          highlight: '.db-reorder-btn',
          highlightLabel: '화면 구성 편집',
        },
        {
